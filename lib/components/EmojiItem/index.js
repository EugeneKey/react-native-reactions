...
const EmojiItem = (props) => {
    const { data, onEmojiPress, titleStyle, titleBoxStyle, emojiContainerStyle, emojiSelectedContainerStyle, selectedEmoji, showTopEmojiCard, emojiKey, emojiStyle, emojiSize, isTouchRelease, isModal = true, setShowPopUpCard = () => { }, onTap = () => { }, 
    // loaded,
    onEmojiCloseModal = () => { }, setTouchRelease = () => { }, } = props;
    const { titlePosition, onLayout, scaled, childRef, 
    // emojiAnimatedScaled,
    wavedEmoji, } = useEmojiItem(props);
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(TouchableOpacity, { hitSlop: { bottom: 30, top: 30 }, ref: childRef, onPress: onEmojiPress, style: [
                styles.root,
                emojiContainerStyle,
                isEmojiSelected && emojiSelectedContainerStyle,
            ], onLayout: onLayout },
            React.createElement(Animated.View, { style: wavedEmoji },
